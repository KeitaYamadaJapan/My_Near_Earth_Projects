...
class NearEarthObject:
    ...
    def __init__(self, designation, name=None, diameter=float('nan'), hazardous="", **info):
    ...
    def __str__(self):
        ...
        if not math.isnan(self.diameter):
            return f"NEO {self.fullname} has a diameter of {self.diameter:.3f} km and is{haz_mess} potentially hazardous."
        return f"NEO {self.fullname} is{haz_mess} potentially hazardous."
